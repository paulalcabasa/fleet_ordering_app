                ...
                <tbody>
                    <tr v-for="(row, index) in projects">
                        <td nowrap>
                            ...
                            <a v-show="row.status_name == 'New' || row.status_name == 'Rejected'" :href="base_url + '/manage-project/edit/' + row.project_id" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
