                        ...
                        <div class="kt-form__section kt-form__section--first">
                            <div class="kt-wizard-v1__form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" autocomplete="off" name="fname" placeholder="Account Name"  aria-describedby="fname-error">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form-text text-muted">Please enter TIN number (XXX-XXX-XXX)</span>
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr v-for="(row, index) in salesPersons">
                                                <td><input type="text" v-model="row.title" class="form-control form-control-sm"></td> 
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <span class="form-text text-muted">Please select a body builder</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-condensed">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>D-MAX RZ4E 4x2 Cab/Chassis</td>
                                                    <td>SPLASH WHITE</td>
                                                 ...
                                                 <tr>
                                                    <td>mu-X 4x2 LS-A AT Luxe</td>
                                                    <td>RED SPINEL MICA</td>
                                                    <td><input type="text" name="" class="form-control form-control-sm" size="4"/></td>
                                                    <td><input type="text" name="" class="form-control form-control-sm"/></td>
                                                    <td><input type="text" name="" class="form-control form-control-sm"/></td>
                                                    <td>
...
var Select2 = function(customerOptions,projectSourceOptions,organizationOptions,paymentTermOptions){
   ...
   var intSelOrg = function(organizationOptions){
    ...
    return {
        init : function(customerOptions,projectSourceOptions,organizationOptions,paymentTermOptions){
...
var KTInputmask = function () {
    ...
    var demos = function () {
        ...
        $("#txt_tin").inputmask({
            "mask": "999-999-999",
            placeholder: "XXX-XXX-XXX" // remove underscores from the input mask
        });
