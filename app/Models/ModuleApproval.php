...
class ModuleApproval extends Model
{
   ...
   public function get_pending_per_po($po_header_id){
    ...
    public function get_fpc_extension_approval(){
        $sql = "SELECT null approval_id,
                        fpc_prj.project_id module_reference_id,
                        'FPC Extension' type, 
                        fpc_prj.project_id,
                        to_char(vr.creation_date,'mm/dd/yyyy HH:MI:SS AM') date_submitted,
                        'Pending' status_name,
                        usr.first_name || ' ' || usr.last_name created_by,
                        null approver_id,
                        null approver_user_id,
                        null approver_source_id,
                        null approver_name,
                        nvl(dlr_sat.account_name,hca.account_name)   dealer_name,
